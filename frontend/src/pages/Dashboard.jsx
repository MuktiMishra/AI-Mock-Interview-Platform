...
function Icon({ name, size = 15 }) {
  ...
  if (name === "spinner")
    return (
      <svg
        style={{ ...s, animation: "spin 1s linear infinite" }}
        viewBox="0 0 24 24"
        fill="none"
        stroke="currentColor"
        strokeWidth="2"
...
const Dashboard = () => {
    ...
    ? [
        {
          ...
          delta: `↑ ${stats.sessionsThisWeek} this week`,
          positive: stats.sessionsThisWeek > 0,
        },
        {
          label: "Avg Score",
          value: `${stats.overallAvg}%`,
          delta: stats.overallAvg >= 70 ? "Keep it up!" : "Room to improve",
          positive: stats.overallAvg >= 70,
        },
        {
          label: "Best Domain",
          value: stats.bestDomain ? capitalize(stats.bestDomain.name) : "—",
          delta: stats.bestDomain
            ? `${stats.bestDomain.count} sessions`
            : "No data yet",
          positive: null,
        },
        {
          ...
          delta: stats.streak > 0 ? "Days in a row" : "Start one today!",
  ...
  return (
    ...
    >
      ...
      {/* Main */}
      <div
        style={{ padding: "84px 28px 40px", maxWidth: 1100, margin: "0 auto" }}
      >
        {/* Error banner */}
        {error && (
          <div
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            >
              ...
              {loading ? (
                ...
                >
                  No sessions yet — complete your first interview to see history
                  here.
                </div>
              ) : (
                <div
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            >
              ...
              {/* Domain cards — clickable, selectedDomain highlights */}
              <div
                style={{
                  display: "grid",
                  ...
                  >
                    <div
                      style={{
                        ...
                        border: `1px solid ${selectedDomain === key ? "rgba(124,58,237,0.5)" : "rgba(124,58,237,0.2)"}`,
                        display: "flex",
                        alignItems: "center",
                        justifyContent: "center",
                        marginBottom: 10,
              ...
              >
                ...
                {selectedDomain
                  ? `Start ${DOMAIN_META[selectedDomain].name} Interview`
                  : "Start Interview"}
              </button>
            </div>
