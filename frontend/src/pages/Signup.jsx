      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex items-start gap-2 text-sm text-gray-500">
            <input type="checkbox" className="accent-purple-500 mt-1" required />
            <span>
              I agree to the <a href="#" className="text-purple-500">Terms</a> and <a href="#" className="text-purple-500">Privacy Policy</a>
            </span>
          </div>
